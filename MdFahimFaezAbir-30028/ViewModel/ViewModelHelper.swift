...
class ViewModelHelper{
    ...
    func setMatchData(matchData: [Datum])-> [HomeModelData]{
        ...
        HomeModelData.homeModelData = data
        return HomeModelData.homeModelData
    }
    ...
    func setData(matches: Datum,matchType: MatchTypes)->HomeModelData {
        let startingAt = TimeConvertion.shared.formatDate(date: matches.startingAt ?? "")
        return HomeModelData(fixId: matches.id ?? 0,
